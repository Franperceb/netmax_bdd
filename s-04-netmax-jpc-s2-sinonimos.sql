...
--@Descripción: Creación de sinónimos para sitio 2

Prompt conectandose a jpcbdd_s2
connect netmax_bdd/netmax_bdd@jpcbdd_s2
Prompt creando sinónimos en jpcbdd_s2
-- programa
...
create or replace synonym usuario_f2 for USUARIO_F2_JPC_S2;
...
create or replace synonym playlist_f3 for PLAYLIST_F2_JPC_S2;
...
--archivo_programa
create or replace synonym archivo_programa_f1 for ARCHIVO_PROGRAMA_F1_JPC_S2;
...
create or replace synonym pais_r2 for PAIS_R_JPC_S2;
...
create or replace synonym tipo_cuenta_r2 for TIPO_CUENTA_R_JPC_S2;
...
create or replace synonym tipo_serie_r2 for TIPO_SERIE_R_JPC_S2;
