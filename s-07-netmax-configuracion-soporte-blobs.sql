...
create or replace directory proyecto_final_pdfs_dir as '/unam-bdd/proy-final/carga-inicial/pdfs/pdfs';

--Objeto tipo Directory empleado para almacenar los trailers de un documental.
create or replace directory proyecto_final_trailers_dir as '/unam-bdd/proy-final/carga-inicial/trailers/trailers';
